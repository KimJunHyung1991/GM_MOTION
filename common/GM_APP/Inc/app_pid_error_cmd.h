...
/**********************************************************************************/
/**********************************************************************************/
void app_rx_error_sub_pid_clear_ctl(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
void app_rx_error_sub_pid_clear_rsp(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
