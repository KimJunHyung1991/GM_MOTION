...
/**********************************************************************************/
void app_rx_error_sub_pid_error_level_ctl(uint8_t num, prtc_header_t *pPh, prtc_data_ctl_error_level_t *pData);
void app_rx_error_sub_pid_error_level_rsp(uint8_t num, prtc_header_t *pPh, prtc_data_rsp_error_level_t *pData);
void app_rx_error_sub_pid_error_level_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
