...
void app_rx_edit_sub_pid_status_ctl(uint8_t num, prtc_header_t *pPh, prtc_data_ctl_edit_status_t *pData);
void app_rx_edit_sub_pid_status_rsp(uint8_t num, prtc_header_t *pPh, prtc_data_rsp_edit_status_t *pData);
void app_rx_edit_sub_pid_status_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
