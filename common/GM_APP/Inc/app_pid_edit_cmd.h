...
void app_rx_edit_sub_pid_action_ctl(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
void app_rx_edit_sub_pid_action_rsp(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
