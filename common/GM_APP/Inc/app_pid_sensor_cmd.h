...
/**********************************************************************************/
void app_rx_sensor_sub_pid_detect_ctl(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
void app_rx_sensor_sub_pid_detect_rsp(uint8_t num, prtc_header_t *pPh, uint8_t *pData);
