...
void app_rx_inspection_sub_pid_data_play_rqt(uint8_t num, prtc_header_t *pPh, prtc_data_rqt_inspection_data_play_t *pData);
void app_tx_inspection_sub_pid_data_play_ctl(uint8_t num, uint8_t priority, uint8_t souce_id, uint8_t target_id, uint8_t souce_sub_id, uint8_t target_sub_id, uint8_t index, uint8_t *data);
void app_tx_inspection_sub_pid_data_play_rsp(uint8_t num, uint8_t priority, uint8_t souce_id, uint8_t target_id, uint8_t souce_sub_id, uint8_t target_sub_id, uint8_t index, uint8_t *data);
