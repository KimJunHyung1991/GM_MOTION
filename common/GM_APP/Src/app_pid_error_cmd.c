...
__weak void app_rx_error_sub_pid_rc_ctl(prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_rc_rsp(prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_rc_rqt(prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_rc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_RC, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_rc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_RC, sub_id), \
...
__weak void app_rx_error_sub_pid_ac_ctl(prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_ac_rsp(prtc_header_t *pPh, uint8_t *pData)
{ 
	
}

__weak void app_rx_error_sub_pid_ac_rqt(prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_ac_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_AC, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_ac_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_AC, sub_id), \
...
__weak void app_rx_error_sub_pid_bldc_ctl(prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_bldc_rsp(prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_bldc_rqt(prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_bldc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_BLDC, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_bldc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_BLDC, sub_id), \
