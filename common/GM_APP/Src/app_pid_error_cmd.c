...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_rc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_RC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_rc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_RC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_RC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_ac_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_AC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_ac_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_AC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_AC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_bldc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_BLDC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_bldc_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_BLDC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_BLDC, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_clear_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_CLEAR, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_clear_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_CLEAR, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_CLEAR, souce_sub_id, target_sub_id), \
...
/**
  ...
  * @retval None
  */
__weak void app_rx_error_sub_pid_error_level_ctl(uint8_t num, prtc_header_t *pPh, prtc_data_ctl_error_level_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_error_level_rsp(uint8_t num, prtc_header_t *pPh, prtc_data_rsp_error_level_t *pData)
{
	
}

__weak void app_rx_error_sub_pid_error_level_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

void app_tx_error_sub_pid_error_level_ctl(uint8_t num, uint8_t priority, uint8_t souce_id, uint8_t target_id, uint8_t souce_sub_id, uint8_t target_sub_id, uint8_t motor_type, char *err_str)
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_error_level_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_ERROR_LEVEL, souce_sub_id, target_sub_id), \
			net_pda_error_sub_pid_error_level_ctl(motor_type, err_str));
}
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_error_level_t), priority, souce_id, target_id, PID_ERROR, ERROR_SUB_PID_ERROR_LEVEL, souce_sub_id, target_sub_id), \
			net_pda_error_sub_pid_error_level_rsp(motor_type, err_str));
}
