...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_midi_adc_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_ADC, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_midi_adc_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_ADC, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_midi_button_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_BUTTON, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_midi_button_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_BUTTON, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_midi_led_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_LED, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_midi_led_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_LED, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_midi_id_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_ID, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_midi_id_t), priority, souce_id, target_id, PID_MIDI, MIDI_SUB_PID_ID, sub_id), \
