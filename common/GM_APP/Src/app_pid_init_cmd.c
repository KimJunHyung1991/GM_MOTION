...
/**
  ...
  * @retval None
  */
__weak void app_rx_init_sub_pid_boot_ctl(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_boot_rsp(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_boot_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
...
{	
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, souce_sub_id, target_sub_id), \
...
__weak void app_rx_init_sub_pid_driver_data1_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_driver_data1_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA1, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_driver_data1_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA1, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA1, souce_sub_id, target_sub_id), \
...
__weak void app_rx_init_sub_pid_driver_data2_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_driver_data2_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA2, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_driver_data2_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA2, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA2, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_status_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_STATUS, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_status_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_STATUS, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, sizeof(prtc_data_rqt_init_status_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_STATUS, souce_sub_id, target_sub_id), \
...
__weak void app_rx_init_sub_pid_absolute_battery_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_absolute_battery_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_ABSOLUTE_BATTERY, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_absolute_battery_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_ABSOLUTE_BATTERY, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_ABSOLUTE_BATTERY, souce_sub_id, target_sub_id), \
...
/**
  ...
  * @retval None
  */
__weak void app_rx_init_sub_pid_move_sensor_ctl(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_move_sensor_rsp(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_move_sensor_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
...
/**
  ...
  * @retval None
  */
__weak void app_rx_init_sub_pid_move_init_position_ctl(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_move_init_position_rsp(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_move_init_position_rqt(uint8_t num, prtc_header_t *pPh, uint8_t *pData)
{
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_INIT_POSITION, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_INIT_POSITION, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_INIT_POSITION, souce_sub_id, target_sub_id), \
			net_pda_init_sub_pid_move_init_position_rqt());
}
/******************************************INIT SUB PID MOVE INIT POSITION APPLICATION*********************************************/
/******************************************INIT SUB PID DATA OP APPLICATION*********************************************/
/**
  * @brief  
  * @param  num : CAN 종류
			*pPh : packet header pointer
...
/**
  ...
  * @retval None
  */
__weak void app_rx_init_sub_pid_driver_type_ctl(uint8_t num, prtc_header_t *pPh, prtc_data_ctl_init_driver_type_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_driver_type_rsp(uint8_t num, prtc_header_t *pPh, prtc_data_rsp_init_driver_type_t *pData)
{
	
}

__weak void app_rx_init_sub_pid_driver_type_rqt(uint8_t num, prtc_header_t *pPh, prtc_data_rqt_init_driver_type_t *pData)
{
