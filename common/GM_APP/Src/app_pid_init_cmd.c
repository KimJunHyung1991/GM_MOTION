...
{	
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_driver_data1_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA1, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_driver_data1_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA1, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA1, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_driver_data2_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA2, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_driver_data2_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA2, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_DRIVER_DATA2, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_status_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_STATUS, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, sizeof(prtc_data_rqt_init_status_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_STATUS, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_init_absolute_battery_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_ABSOLUTE_BATTERY, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_init_absolute_battery_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_ABSOLUTE_BATTERY, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_ABSOLUTE_BATTERY, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_SENSOR, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_SENSOR, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_SENSOR, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_INIT_POSITION, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_INIT_POSITION, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_MOVE_INIT_POSITION, sub_id), \
