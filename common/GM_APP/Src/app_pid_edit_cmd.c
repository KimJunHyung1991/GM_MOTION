...
{
	hal_can_protocol_tx(net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_edit_action_t), priority, souce_id, target_id, PID_EDIT, EDIT_SUB_PID_ACTION, sub_id), \
...
{
	hal_can_protocol_tx(net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_edit_action_t), priority, souce_id, target_id, PID_EDIT, EDIT_SUB_PID_ACTION, sub_id), \
