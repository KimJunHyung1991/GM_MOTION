...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_sensor_detect_t), priority, souce_id, target_id, PID_SENSOR, SENSOR_SUB_PID_DETECT, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_sensor_detect_t), priority, souce_id, target_id, PID_SENSOR, SENSOR_SUB_PID_DETECT, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_REQUEST, 0, priority, souce_id, target_id, PID_SENSOR, SENSOR_SUB_PID_DETECT, sub_id), \
