...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_motion_profile_position_t), priority, souce_id, target_id, PID_MOTION, MOTION_SUB_PID_DIRECTION, souce_sub_id, target_sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_motion_profile_position_t), priority, souce_id, target_id, PID_MOTION, MOTION_SUB_PID_DIRECTION, souce_sub_id, target_sub_id), \
