...
{
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_motion_raw_data_t), priority, souce_id, target_id, PID_MOTION, MOTION_SUB_PID_PROFILE_POSITION, souce_sub_id, target_sub_id), \
			net_pda_motion_sub_pid_raw_data_ctl(raw_data));
}
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_motion_raw_data_t), priority, souce_id, target_id, PID_MOTION, MOTION_SUB_PID_PROFILE_POSITION, souce_sub_id, target_sub_id), \
			net_pda_motion_sub_pid_raw_data_rsp(raw_data));
}
