...
{	
	hal_can_protocol_tx(num, net_pha(CMD_CONTROL, sizeof(prtc_data_ctl_inspection_data_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, sub_id), \
...
{
	hal_can_protocol_tx(num, net_pha(CMD_RESPONSE, sizeof(prtc_data_rsp_inspection_data_t), priority, souce_id, target_id, PID_INIT, INIT_SUB_PID_BOOT, sub_id), \
